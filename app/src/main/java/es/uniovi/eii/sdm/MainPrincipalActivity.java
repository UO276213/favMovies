...
import es.uniovi.eii.sdm.datos.db.MyDBHelper;
...
public class MainPrincipalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_popular, R.id.nav_fav, R.id.nav_slideshow)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.action_settings:
                ...
                break;
            case R.id.action_borrar_fav:
                borrarBd(getApplicationContext());
                break;
        }
        return super.onOptionsItemSelected(item);
    }

    private void borrarBd(Context context) {
        MyDBHelper dbHelper = new MyDBHelper(context, null, null, 1);
